...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/product/location/row/{row}/place/{place}": {
            "get": {
        ...
        "/product/status/name/{name}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "ProductStatus Name",
                        "name": "name",
                        "in": "path",
                        "required": true
                    }
        ...
        "/supply/item": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "SupplyItem info",
                        "name": "input",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.SupplyItem"
                        }
                    }
                ],
                "responses": {
